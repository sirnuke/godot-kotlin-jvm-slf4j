...
class GodotLogger(private val name: String) : Logger {
    ...
    override fun trace(format: String?, arg1: Any?, arg2: Any?) = formatAndLog(LocationAwareLogger.TRACE_INT, format, arg1, arg2)
    override fun trace(format: String?, vararg arguments: Any?) = formatAndLog(LocationAwareLogger.TRACE_INT, format, arguments)
    ...
    override fun debug(format: String?, arg1: Any?, arg2: Any?) = formatAndLog(LocationAwareLogger.DEBUG_INT, format, arg1, arg2)
    override fun debug(format: String?, vararg arguments: Any?) = formatAndLog(LocationAwareLogger.DEBUG_INT, format, arguments)
    ...
    override fun info(format: String?, arg1: Any?, arg2: Any?) = formatAndLog(LocationAwareLogger.INFO_INT, format, arg1, arg2)
    override fun info(format: String?, vararg arguments: Any?) = formatAndLog(LocationAwareLogger.INFO_INT, format, arguments)
    ...
    override fun warn(format: String?, arg1: Any?, arg2: Any?) = formatAndLog(LocationAwareLogger.WARN_INT, format, arg1, arg2)
    override fun warn(format: String?, vararg arguments: Any?) = formatAndLog(LocationAwareLogger.WARN_INT, format, arguments)
    ...
    override fun error(format: String?, arg1: Any?, arg2: Any?) = formatAndLog(LocationAwareLogger.ERROR_INT, format, arg1, arg2)
    override fun error(format: String?, vararg arguments: Any?) = formatAndLog(LocationAwareLogger.ERROR_INT, format, arguments)
